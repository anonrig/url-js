...
function is_query_percent_encoded(code) {
  return query_percent_encodes[code] !== undefined || is_c0_control_percent_encoded(
    code,
  );
}
...
function is_path_percent_encoded(code) {
  return path_percent_encodes[code] !== undefined || is_query_percent_encoded(
    code,
  );
}
...
function is_userinfo_percent_encoded(code) {
  return user_info_percent_encodes[code] !== undefined || is_path_percent_encoded(
    code,
  );
}
...
function is_fragment_percent_encoded(code) {
  return extra_fragment_percent_encodes[code] !== undefined || is_c0_control_percent_encoded(
    code,
  );
}
