...
function is_path_percent_encoded(code, character) {
  return path_percent_encodes[character] !== undefined && is_query_percent_encoded(code, character);
}
...
function is_fragment_percent_encoded(code, character) {
  return extra_fragment_percent_encodes[character] !== undefined && is_control_percent_encoded(code);
}
